...
*/
// let doubleValues = forEach(arr, function(num){
//     console.log(num * 2);
// })
...
function doubleValuesWithMap(arr) {
    return arr.map(function(num){//IMPORTANT REMEMBER TO RETURN MAP
        return num * 2;
    })
...
function valTimesIndex(arr){
    return arr.map(function(num, i){//DONT FORGET MAP CAN GO THROUGH THE INDEX AND ARRAY
        return num * i;
    })
}
...
function filterByValue(arr, key) {
    return arr.filter(function(val){//ITS FILTER NOT FILTERBY VALUE 
